...
- (BOOL)application:(UIApplication *)application openURL:(NSURL *)url sourceApplication:(NSString *)sourceApplication annotation:(id)annotation {
    ...
    [self.mainController importFile:url];
...
- (void)configureAudioSession
{
    ...
    [mySession setCategory: AVAudioSessionCategoryPlayAndRecord withOptions:AVAudioSessionCategoryOptionMixWithOthers
                     error: &audioSessionError];
    
    double hwSampleRate = 44100.0;
    [mySession setPreferredSampleRate: hwSampleRate
                                error: &audioSessionError];
    
    NSTimeInterval bufferDuration = 0.005;
    [mySession setPreferredIOBufferDuration: bufferDuration
                                      error: &audioSessionError];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TabletRadio" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"TabletRadio.sqlite"];
